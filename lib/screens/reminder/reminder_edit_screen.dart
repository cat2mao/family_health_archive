...
class _ReminderEditScreenState extends ConsumerState<ReminderEditScreen> {
  ...
  final _dailyTimesController = TextEditingController();
  ...
  Future<void> _load() async {
    if (widget.reminderId != null) {
      ...
      if (row != null && mounted) {
        ...
        _dailyTimesController.text = row.dailyTimes ?? '';
      ...
      if (_isEdit && _existing != null) {
        final updated = _existing!.copyWith(
          ...
          dailyTimes: _type == ReminderType.medication
              ? _dailyTimesController.text.trim().isEmpty
                  ? null
                  : _dailyTimesController.text.trim()
              : null,
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: TextFormField(
                              controller: _dailyTimesController,
                              decoration: const InputDecoration(
                                labelText: '每日次数',
                                border: OutlineInputBorder(),
